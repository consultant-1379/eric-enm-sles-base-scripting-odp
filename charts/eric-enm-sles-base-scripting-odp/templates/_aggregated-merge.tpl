...
*/ -}}
{{- define "eric-enm-sles-base-scripting-odp.aggregatedMerge" -}}
  {{- $merged := dict -}}
  {{- $context := .context -}}
  {{- $location := .location -}}
...
*/ -}}
{{- define "eric-enm-sles-base-scripting-odp.mergeAnnotations" -}}
  {{- include "eric-enm-sles-base-scripting-odp.aggregatedMerge" (dict "context" "annotations" "location" .location "sources" .sources) }}
{{- end -}}
{{- define "eric-enm-sles-base-scripting-odp.mergeLabels" -}}
  {{- include "eric-enm-sles-base-scripting-odp.aggregatedMerge" (dict "context" "labels" "location" .location "sources" .sources) }}
{{- end -}}
